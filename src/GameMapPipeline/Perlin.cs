...
namespace maps.GameMapPipeline
{
    public static class Perlin
    {
        private static readonly int[] permutation = new int[]
        {
            ...
            51,145,235,249,14,239,107,49,192,214,
            31,181,199,106,157,184, 84,204,176,
            115,121,50,45,127,  4,150,254,138,
            236,205, 93,222,114, 67,29,24, 72,
            243,141,128,195,78, 66,215,61,156,180
        };


        private static readonly int[] p; // doubled permutation
        ...
        public static float Noise(float x, float y)
        {
            ...
            return (Lerp(x1, x2, v) + 1f) * 0.5f; // normalize 0–1
        }
